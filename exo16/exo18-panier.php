...
<head>
    ...
    <style>
        ...
        a      { margin-right: 15px; }
        .supprimer { color: red; }
        .valider   { background: #4CAF50; color: white; padding: 10px 20px;
...
<body>
    ...
    <?php else: ?>
        <table>
            <tr>
                <th>Article</th><th>Prix unitaire</th><th>Quantité</th><th>Sous-total</th><th>Action</th>
            </tr>
            ...
            <?php endforeach; ?>
            <tr class="total"><td colspan="3">Total HT</td><td colspan="2"><?= round($totalHT, 2) ?> €</td></tr>
            <tr class="total"><td colspan="3">TVA (20%)</td><td colspan="2"><?= $tva ?> €</td></tr>
            <tr class="total"><td colspan="3">Total TTC</td><td colspan="2"><?= $totalTTC ?> €</td></tr>
        </table>
